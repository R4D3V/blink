      ...
      <section className="border-t border-line">
        <Reveal className="mx-auto max-w-6xl px-6 py-16">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-display text-3xl italic md:text-4xl">
          ...
          <div className="mt-10 grid items-start gap-10 lg:grid-cols-[1fr_340px]">
            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-3xl border border-line bg-surface p-6 text-sm leading-relaxed text-muted">
                ...
                <p className="mt-3">
                  $NASDOG is a memecoin with no intrinsic value guarantee.
                  Price can move fast and liquidity is concentrated on
                  pump.fun. Hold only what you can afford to lose, and do
