    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white p-8">
      <div className="max-w-5xl mx-auto">
        <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-3">
              <Link
                href="/welcome"
                className="px-4 py-2 bg-primary rounded-full font-medium hover:shadow-lg"
              >
                Welcome
              </Link>
              <Link
                href="/"
                className="px-4 py-2 border border-border rounded-full text-foreground hover:bg-muted"
              >
                Open Chat
              </Link>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <p>
              We're building innovative solutions to help you stay connected and
              productive.
            </p>
          </AnimatedCard>
        ...
        >
          <p className="text-slate-300 max-w-2xl leading-relaxed">
            Blink is built to make real-time communication simple. With a modern
            UI, fast messaging, and peer-to-peer calls, Blink helps you connect
            without friction.
          </p>
          <div className="mt-6 flex gap-3">
            <Link
              href="/welcome"
              className="px-5 py-3 bg-primary rounded-full text-white font-medium hover:shadow-lg"
            >
              Back to Welcome
            </Link>
            <Link
              href="/"
              className="px-5 py-3 border border-border rounded-full text-foreground hover:bg-muted"
            >
              Open Chat
            </Link>
          </div>
