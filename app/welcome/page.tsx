      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="mt-4 text-sm text-muted-foreground max-w-md">
              Demo login is enabled — click "Continue with Google" on the
              login screen to explore without an account.
            </div>
          </div>
        ...
        <div id="features" className="mt-16 grid md:grid-cols-3 gap-6">
          <AnimatedCard
            ...
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.8L3 20l.8-4A8.94 8.94 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>}
          >
            <p className="text-slate-300">Instant messages with typing indicators and read receipts.</p>
          </AnimatedCard>

          <AnimatedCard
            title="Video & Audio Calls"
            delay={120}
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M4 6h11a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z"/></svg>}
          >
            <p className="text-slate-300">Peer-to-peer calls with mute, video, & invite controls.</p>
          </AnimatedCard>

          <AnimatedCard
            title="Media & Files"
            delay={240}
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M7 16l-4-4m0 0l4-4m-4 4h18"/></svg>}
          >
            <p className="text-slate-300">Share images, videos, and files quickly and preview them inline.</p>
          </AnimatedCard>
        </div>
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          <div className="p-6 bg-card/60 backdrop-blur rounded-lg">
            ...
            <p className="text-slate-300">We don't sell your data. Local demo mode keeps your info on your device unless you connect an external backend.</p>
          </div>

          <div className="p-6 bg-card/60 backdrop-blur rounded-lg">
            <h3 className="text-lg font-semibold mb-2">Installable</h3>
            <p className="text-slate-300">Blink supports PWA installation. Install it on your device for faster access and native-like behavior.</p>
          </div>
        </div>

        <footer className="mt-12 text-center text-sm text-muted-foreground">
          <p>
            Built with ❤️ — <Link href="/about" className="text-primary underline">About</Link> · <Link href="/" className="text-primary underline">Open Chat</Link>
          </p>
        </footer>
      </section>
    </main>
